...
test('critical app surfaces have complete Romanian and Thai copy', () => {
  const critical = [
    ...
    'Exercise list',
    'Change legs',
    'Exercise saved. Rest continues.',
    'Predefined list',
    'Your meal guide',
    'Save configuration',
    'Save meal & close',
    'Reorderable Simple Mode blocks',
    'Done editing',
    ...
    'Migros Oh! protein-rich milk',
    'saved protein or whey providing 35-40 g protein',
    'sweet potato or equivalent rice/bulgur',
