...
- Duration remains an estimate, not a stopwatch guarantee. Native retains its existing rounded-minute estimate; web uses its seconds estimate. Longer budgets do not invent extra volume. Broader goal-specific prescription personalization and calorie-calibration cadence remain separate open findings. Release 392 delivery/publication evidence follows.
