...
export const ATHLETE_SUPPORT_PROTOCOLS: Partial<Record<PersonaSlug, AthleteSupportProtocol>> = {
  constantine: {
    meals: [
      ...
      { time: '19:15', name: 'Dinner', foods: ['300 g sweet potato', '150 g saved protein', 'Vegetables', '10 g EVOO', 'Iodized salt'] },
    ],
  ...
  june: {
    meals: [
      ...
      { time: '15:30', name: 'Snack', foods: ['1 banana or another saved fruit'] },
      { time: '19:15', name: 'Dinner', foods: ['300 g sweet potato or equivalent rice/bulgur', '100-120 g saved protein', 'Vegetables', '5-15 g EVOO according to protein choice'] },
    ],
