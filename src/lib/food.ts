...
const FOOD_SEARCH_PHRASES: Record<'ro' | 'th', Record<string, string>> = {
  ro: {
    ...
    'phad kaprao moo sab': 'phad kaprao moo sab',
    'phad kaprao neua sab': 'phad kaprao neua sab',
    'pad kra pao moo sab': 'phad kaprao moo sab',
    'pad kra pao neua sab': 'phad kaprao neua sab',
    'pad thai': 'pad thai',
  ...
  th: {
    ...
    'แคปหมู': 'kap moo pork cracklings',
    'ไข่ดาว': 'khai dao fried egg',
    'ผัดกะเพราหมูสับ': 'phad kaprao moo sab',
    'ผัดกระเพราหมูสับ': 'phad kaprao moo sab',
    'ผัดกะเพราเนื้อสับ': 'phad kaprao neua sab',
    'ผัดกระเพราเนื้อสับ': 'phad kaprao neua sab',
    'ผัดไทย': 'pad thai',
...
const FOOD_SEARCH_TOKENS: Record<'ro' | 'th', Record<string, string>> = {
  ...
  th: {
    ...
    หมูกรอบ: 'crispy fried pork belly', แคปหมู: 'kap moo pork cracklings',
    ผัดกะเพรา: 'phad kaprao', ผัดกระเพรา: 'phad kaprao', ไข่ดาว: 'khai dao fried egg',
...
const FOOD_CATALOG_ALIASES: Record<string, string[]> = {
  ...
  'apex-protocol:generic:khai-dao-thai-fried-egg': [
    'khai dao', 'kai dao', 'thai fried egg', 'fried egg thai style', 'fried egg', 'ไข่ดาว',
  ],
