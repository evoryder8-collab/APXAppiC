...
const COPY = {
  en: {
    ...
    build: 'Build my plan', review: 'Build a new plan', guide: 'Plan guide', mainButton: 'Set up my main phase',
  ...
  ro: {
    ...
    build: 'Construiește planul', review: 'Creează un plan nou', guide: 'Ghidul planului', mainButton: 'Configurează faza principală',
  ...
  th: {
    ...
    build: 'สร้างแผนของฉัน', review: 'สร้างแผนใหม่', guide: 'คำแนะนำแผน', mainButton: 'ตั้งค่าช่วงหลัก',
